...
public class FormElement extends FormObject {
    ...
    private String customColor;//主题色
    ...
    public FormElement setTextSize(float textSize) {
    ...
    public FormElement setHintColor(int hintColor) {
    ...
    public FormElement setTextColor(int textColor) {
...
//        this.options = options;
    ...
    public Integer getCursorDrawable() {
    ...
    public FormElement setBackgroundDrawable(Drawable backgroundDrawable) {
        this.backgroundDrawable = backgroundDrawable;
        return this;
    }

    public FormElement setCursorDrawable(Integer cursorDrawable) {
    ...
    public FormElement setCustomColor(String customColor) {

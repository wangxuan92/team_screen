...
public class Bootstrap {
    ...
    public static synchronized void startAlwaysOnService(Context context,
        ...
        if (!AlwaysOnService.isRunning) {
            ...
            pIntent.putExtra(ActivityManager.STARTUP_ACTION_NAME, loadedFrom);
            ...
            mIntent.putExtra(ActivityManager.STARTUP_ACTION_NAME, loadedFrom);
            ...
            am.setRepeating(AlarmManager.RTC_WAKEUP, time.getTimeInMillis(),
                    ActivityManager.ALARM_REPEAT_INTERVAL * 1000, sender);

...
public class FaceDB {
    ...
    public static String appid = "FDoZZKWK3Q5x8G6TZnoBeeJxfBkEainKtcjM2MiZqjBw";
    public static String ft_key = "rkejtnoGntQmmgAoSnRr7UfAPdXvUWLd1cdJTTFubU2";
    public static String fd_key = "rkejtnoGntQmmgAoSnRr7UnKntkvyrBQ1vSSLeoiVfa";
    public static String fr_key = "rkejtnoGntQmmgAoSnRr7VGyPwPkJuJeDXrPwDiioxu";
